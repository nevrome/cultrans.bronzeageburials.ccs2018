...
\begin{textblock*}{65pt}(295pt,110pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
...
![Correlation coefficient over time for 50 **simulation** runs and the **real world data**](figures/sed_simulation_step_1.jpeg){ height=85%  }
...
![Correlation coefficient over time for 50 **simulation** runs and the **real world data**](figures/sed_simulation_step_2.jpeg){ height=85%  }
...
![Correlation coefficient over time for 50 **simulation** runs and the **real world data**](figures/sed_simulation_step_3.jpeg){ height=85%  }
...
![Correlation coefficient over time for 50 **simulation** runs and the **real world data**](figures/sed_simulation_step_4.jpeg){ height=85%  }
...
![Correlation coefficient over time for 50 **simulation** runs and the **real world data**](figures/low_spatial_interaction.jpeg){ height=85%  }
...
![Correlation coefficient over time for 50 **simulation** runs and the **real world data**](figures/high_spatial_interaction.jpeg){ height=85%  }
