...
\begin{textblock*}{65pt}(5pt,40pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      ...
      \textbf{Radon-B:} Database for European \textsuperscript{14}C dates for the Bronze and Early Iron Age
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{65pt}(295pt,40pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Radiocarbon dating is one of the most important absolute dating methods for organic material younger than 50.000BC
    \end{minipage}}%
\end{textblock*}


\begin{textblock*}{65pt}(5pt,110pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Metainformation for dates from graves: \textbf{burial type} \& \textbf{burial construction}
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{75pt}(30pt,140pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Divide and Conquer: Separation into eight artificial regions within the area of the highest data density
    \end{minipage}}%
\end{textblock*}
...
\begin{columns}
  \begin{column}{0.48\textwidth}
    \begin{figure}
      ...
      \caption{\textbf{burial type} development: Sum of \textsuperscript{14}C dates whose $2\sigma$ range cover respective year.}
    \end{figure}
  \end{column}
...
\begin{textblock*}{120pt}(215pt,220pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Data structure transformation: Individual \textsuperscript{14}C dates to time series of burial rite \textbf{presence}
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{120pt}(215pt,220pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Data structure transformation: Time series of absolute appearances to time series of burial rite \textbf{proportions} - \textbf{burial rite proxy}
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{55pt}(300pt,40pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Low distance at the start and end due to \textbf{universal shift from inhumation to cremation}
    \end{minipage}}%
\end{textblock*}

\begin{textblock*}{55pt}(10pt,170pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
...
![Example Population Graph. Arranged with the Fruchterman & Reingold algorithm.](figures/population_graph_connection_001.jpeg){ height=85% }
...
\begin{textblock*}{130pt}(20pt,50pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      ...
      Implementierung: R Paket \textbf{popgenerator} to create population networks with varaible population size development, number of groups, degree of intergroup transmission, etc.
    \end{minipage}}%
\end{textblock*}

\begin{textblock*}{100pt}(250pt,160pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \footnotesize\raggedright\color{white}
  ...
  for (auto& i : all_neighbors_information) {
    ...
    if (std::get<3>(i)) {
      success = std::make_pair(
        std::get<0>(i), 
        std::get<1>(i) * log2( (double) std::get<2>(i) + 1) >= randunifrange(75, 100)
      );
    } else {
      success = std::make_pair(
        std::get<0>(i), 
        std::get<1>(i) * log2( (double) std::get<2>(i) + 1) >= randunifrange(0, 100)
      );
    }
...
\begin{textblock*}{130pt}(210pt,210pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \footnotesize\raggedright\color{white}
      Implementierung: C++ CLI program \textbf{gluesless} to simulate idea expansion within the population network
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{55pt}(10pt,30pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Is correlation of spatial and cultural distance still plausible?
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{55pt}(10pt,90pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Simulation results in comparison with real world data
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{55pt}(10pt,150pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      The real world correlation is mostly within the spectrum of equal integroup distance simulations   
    \end{minipage}}%
\end{textblock*}
...
![Same plot, but simulations now with low **spatial intergroup distance**.](figures/low_spatial_interaction.jpeg){ height=88%  }
...
\begin{textblock*}{60pt}(300pt,30pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Spatial intergroup distance in the population graph increases correlation. 
    \end{minipage}}%
\end{textblock*}

## Simulation Application: Correlation of Spatial and Cultural Distance

![Same plot, but simulations now with **high** spatial intergroup distance.](figures/high_spatial_interaction.jpeg){ height=88%  }
...
\begin{textblock*}{60pt}(300pt,100pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Generally more interaction increases correlation. 
    \end{minipage}}%
\end{textblock*}

\begin{textblock*}{60pt}(300pt,150pt)
  \setlength\fboxrule{2pt}%
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
