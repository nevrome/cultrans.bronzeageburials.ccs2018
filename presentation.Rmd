...
\begin{textblock*}{65pt}(5pt,110pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Radiocarbon dating is one of the most important absolute dating methods: One date equals a \textbf{fuzzy point in space and time with context information}
    \end{minipage}}%
\end{textblock*}
...
- **Drift:** Dominance of individual traits due to stochastic processes
...
\begin{textblock*}{130pt}(20pt,50pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      ...
      Implementation: R Package \textbf{popgenerator} to create population networks with variable \textbf{population size development}, \textbf{number of groups}, \textbf{degree of intergroup transmission}, etc.
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{100pt}(250pt,160pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \footnotesize\raggedright\color{white}
      Every individual's position in social space and time is defined by their connections
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{130pt}(210pt,210pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \footnotesize\raggedright\color{white}
      Implementation: C++ CLI program \textbf{gluesless} to simulate idea expansion within the population network
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{55pt}(10pt,150pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      The real world correlation is mostly within the spectrum of equal intergroup distance simulations   
    \end{minipage}}%
\end{textblock*}
...
- The diffusion of the cremation funeral tradition and traditions of flat vs. mound graves are mostly **independent**, except for a short period in the late Early Bronze Age.
...
- Both contexts can both be explained by **neutral variant drift and flow** on a large scale. Local innovation might not have been necessary.
