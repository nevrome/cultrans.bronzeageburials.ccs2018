...
![Radon-B ^14^C dates of graves 2200-800 calBC (Albers Equal Area Conic)](figures/general_map.jpeg){ height=90% }

## Research Area and Regions

![Artifical Regions: 400km distance, 240km radius, >= 70 dates](figures/general_map_research_area_regions.jpeg){ height=90% }
...
![Development of **burial type** SED for all regions relations](figures/regions_regions_squared_euclidian_distance_burial_type.jpeg){ height=90% }
...
![Mean **burial type** SED for all regions relations](figures/regions_regions_mean_squared_euclidian_distance_burial_type.jpeg){ height=90% }
...
![Mean **burial construction** SED for all regions relations](figures/regions_regions_mean_squared_euclidian_distance_burial_construction.jpeg){ height=90% }
...
![Spatial distance network and definition of distance classes](figures/general_map_distance_network.jpeg){ height=90% }
