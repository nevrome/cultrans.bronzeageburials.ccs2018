...
\begin{textblock*}{65pt}(295pt,40pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Radiocarbon dating is one of the most important absolute dating methods: One date equals a \textbf{point in space and time with context information}
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{120pt}(215pt,220pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      Data structure transformation: Individual \textsuperscript{14}C dates to \textbf{time series} of burial rite \textbf{presence}
    \end{minipage}}%
\end{textblock*}
...
\begin{textblock*}{65pt}(5pt,110pt)
  ...
  \noindent\fbox{%
    \begin{minipage}{\linewidth - 2\fboxsep - 2\fboxrule}%
      \raggedright\footnotesize\color{white}
      \textbf{Sociocultural complexity} in the Bronze Age is generally \textbf{increasing}. Still the \textbf{homogeneity \& heterogeneity of certain cultural traits} vary greatly.
    \end{minipage}}%
\end{textblock*}
